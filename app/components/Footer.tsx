export default function Footer() {
  return (
    <footer className="border-t border-[#111111] py-8 px-6">
      <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
        <span className="text-xs text-[#444444] font-mono">
          © {new Date().getFullYear()} Jack Roper. All rights reserved.
        </span>
        <div className="flex items-center gap-5">
          ...
          >
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <path d="M3 8l9 6 9-6M3 8a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2V8z" />
            </svg>
          </a>
        </div>
      </div>
